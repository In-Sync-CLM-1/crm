// crm external scheduler — ONE Cloudflare Worker per task.
...
// pg_cron + pg_net.
const FN_BASE = "https://mlvgqudcwlkolsbighnn.supabase.co/functions/v1";
const RPC_BASE = "https://mlvgqudcwlkolsbighnn.supabase.co/rest/v1/rpc";
