...
const DEFAULT_SETTINGS: BillingSettings = {
  ...
  default_notes: "We value your business and trust.",
  default_tax_rate: 18,
  default_due_days: 30,
  default_hsn: "998314",
  invoice_prefix: "INV",
...
export function useBillingData() {
    ...
    try {
      ...
      if (settingsData) {
        setSettingsState({
          ...
          default_notes: (settingsData as any).default_notes || DEFAULT_SETTINGS.default_notes,
          default_proforma_notes: (settingsData as any).default_proforma_notes || undefined,
          default_credit_note_notes: (settingsData as any).default_credit_note_notes || undefined,
  ...
  const updateSettings = useCallback(async (s: BillingSettings) => {
    ...
    const row = {
      ...
      default_proforma_notes: data.default_proforma_notes || null,
      default_credit_note_notes: data.default_credit_note_notes || null,
