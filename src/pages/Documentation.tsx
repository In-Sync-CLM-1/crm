...
const Deployment = () => (
  <div className="space-y-8">
    <div>
      ...
      <p className="text-muted-foreground mb-6">
        Production deployment on Cloudflare Pages with Supabase backend
      </p>
    </div>
      ...
      <div className="space-y-3">
        <div className="p-4 bg-muted rounded">
          ...
          <ul className="text-sm space-y-1 text-muted-foreground">
            ...
            <li>• <strong>CDN:</strong> Cloudflare global edge network</li>
    ...
    <Card className="p-6">
      ...
      <div className="space-y-2">
        {[
          { item: "Cloudflare Account", desc: "With Pages access and API token" },
          { item: "Supabase Project", desc: "Production-ready instance" },
          { item: "GitHub Repository", desc: "For source control" },
    ...
    <Card className="p-6">
      ...
      <div className="space-y-4">
        <div className="border-l-4 border-primary pl-4">
          <h4 className="font-semibold mb-2">1. Frontend Deployment (Cloudflare Pages)</h4>
          <div className="space-y-2 text-sm">
            <p className="text-muted-foreground">Build locally and deploy via Wrangler:</p>
            <div className="bg-muted p-3 rounded font-mono text-xs">
              <pre>{`npm run build
npx wrangler pages deploy dist --project-name=<your-project>`}</pre>
            </div>
            <p className="text-muted-foreground mt-2">Requires CLOUDFLARE_API_TOKEN and CLOUDFLARE_ACCOUNT_ID in your environment.</p>
          </div>
        </div>
        ...
        <div className="border-l-4 border-blue-500 pl-4">
          ...
          <div className="space-y-2 text-sm">
            <p className="text-muted-foreground">Set environment variables in Cloudflare Pages project settings:</p>
            <div className="bg-muted p-3 rounded font-mono text-xs">
...
supabase functions deploy`}</pre>
    ...
    <Card className="p-6">
      ...
      <div className="space-y-3">
        <div>
          <h4 className="font-semibold text-sm mb-2">Cloudflare Pages</h4>
          <ol className="text-sm space-y-2 text-muted-foreground list-decimal list-inside">
            <li>Open the Pages project in the Cloudflare dashboard → Custom domains</li>
            <li>Add your domain (e.g., app.yourdomain.com)</li>
            <li>If the domain is already on Cloudflare, the CNAME is provisioned automatically; otherwise add a CNAME pointing to the Pages URL:
              <div className="bg-muted p-2 rounded mt-1 font-mono text-xs">
                CNAME app → [project].pages.dev
              </div>
            </li>
            <li>SSL certificate is auto-provisioned via Cloudflare Universal SSL</li>
          </ol>
        </div>
      </div>
    </Card>
    ...
    <Card className="p-6 bg-blue-500/10 border-blue-500/50">
      ...
      <div className="space-y-3 text-sm">
        <div>
          ...
          <p className="text-muted-foreground">Cloudflare dashboard → Pages project → Functions logs / Real-time logs for frontend errors</p>
        </div>
        <div>
