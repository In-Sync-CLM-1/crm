...
- 2024, mid-recovery: closed ~8 mid-to-large accounts that stayed 6-15 months — read at the time as proof of stability, a foot in the door with bigger organizations. In hindsight, false confidence: the product was already failing quietly at the execution/shop-floor level, and early signals were misdiagnosed as "adoption issues," not product breakage.
- On the strength of that read, decided he was ready to scale and hired a small sales and marketing team. Ran CXO roundtables through late 2024 — these expanded usage within accounts he already had, but did not win new logos. Revenue grew ~4x that year; 13 new customers landed in H1'25. Looked like a growth story from the outside.
- The real mechanism underneath: his tech side was strong at prototypes, so any time sales asked "can we build this for a customer," the answer was reflexively yes — no signoff, no pricing discipline, no check against real delivery capacity. Sales sold commitments the build side couldn't price or resource.
- H2'25: it all came due. Lost every one of the 13 H1'25 accounts, and most of what he'd closed in 2024. His own framing of it: "the CAC was mine to keep, the ARR was not." Still recovering from that shock as of this writing.
- What actually held the business together afterward wasn't a sales fix — it was the AI-rebuild (below): strong enough delivery to keep the customers who did stay and slowly expand what they used In-Sync for. Not fully healed, but no longer the bottomless pit it looked like from inside H2'25.
