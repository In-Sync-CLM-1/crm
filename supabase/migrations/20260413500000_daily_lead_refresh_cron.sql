...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    ...
    headers := '{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1sdmdxdWRjd2xrb2xzYmlnaG5uIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3ODk4OTM5MSwiZXhwIjoyMDk0NTY1MzkxfQ.rv0qN3IfrADHXNexeoo_s-TxtbYU9ew3PQRBZnTCZ5Y"}'::jsonb,
    body    := '{}'::jsonb
  )
  $$
);
