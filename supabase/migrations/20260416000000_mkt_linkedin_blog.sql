...
SELECT cron.schedule('linkedin-slot-0', '0 2 * * *',    -- 07:30 IST
  $$SELECT net.http_post(url:='https://mlvgqudcwlkolsbighnn.supabase.co/functions/v1/mkt-blog-writer',headers:='{"Content-Type":"application/json","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1sdmdxdWRjd2xrb2xzYmlnaG5uIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3ODk4OTM5MSwiZXhwIjoyMDk0NTY1MzkxfQ.rv0qN3IfrADHXNexeoo_s-TxtbYU9ew3PQRBZnTCZ5Y"}'::jsonb,body:='{}'::jsonb) AS request_id$$);
...
SELECT cron.schedule('linkedin-engagement-tracker', '30 17 * * *',  -- 23:00 IST
  $$SELECT net.http_post(url:='https://mlvgqudcwlkolsbighnn.supabase.co/functions/v1/mkt-linkedin-engagement-tracker',headers:='{"Content-Type":"application/json","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1sdmdxdWRjd2xrb2xzYmlnaG5uIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3ODk4OTM5MSwiZXhwIjoyMDk0NTY1MzkxfQ.rv0qN3IfrADHXNexeoo_s-TxtbYU9ew3PQRBZnTCZ5Y"}'::jsonb,body:='{}'::jsonb) AS request_id$$);
